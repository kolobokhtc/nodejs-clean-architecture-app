...
app 
 └ lib                              → Application sources 
    ...
    └ infrastructure                → Frameworks, drivers and tools such as Database, the Web Framework, mailing/logging/glue code etc.
       ...
       └ factories                  → Application factories (ex: RepositoryFactories)
       ...
       └ repositories               → Implementation of domain repository interfaces
          └ inmemory                  → Implementation of domain repository interfaces for inmemory driver
          └ mongo                     → Implementation of domain repository interfaces for mongo driver
          └ sql                       → Implementation of domain repository interfaces for sql driver
       ...
       └ webserver                  → Hapi.js Web server configuration (server, routes, plugins, etc.)
          └ models                  → Hapi.js request/response models for routes parametrs validations
            └ user                  → Hapi.js request/response models for user routes
